      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20 lg:h-24">
          <Link href="/" className="flex items-center gap-2 shrink-0">
            <Image src="/logoheader.png" alt="DR Detail" width={170} height={100} className="h-14 lg:h-[72px] w-auto" priority />
          </Link>
                ...
                {servicesOpen && (
                  <div className="absolute top-full left-0 mt-0 pt-2">
                    <div className="bg-dark-lighter border border-white/10 rounded-lg shadow-xl py-2 w-64">
                      ...
                      <Link href="/services/interior-detailing" className="block px-4 py-2.5 text-base text-gray-300 hover:bg-primary/20 hover:text-primary transition">Auto Detailing</Link>
                      <Link href="/services/paint-protection" className="block px-4 py-2.5 text-base text-gray-300 hover:bg-primary/20 hover:text-primary transition">Paint Correction</Link>
                      <Link href="/services/exterior-detailing" className="block px-4 py-2.5 text-base text-gray-300 hover:bg-primary/20 hover:text-primary transition">Ceramic Coating</Link>
                      <Link href="/services/exterior-detailing" className="block px-4 py-2.5 text-base text-gray-300 hover:bg-primary/20 hover:text-primary transition">Car Washing &amp; Window Tinting</Link>
                    </div>
                  </div>
                )}
              </div>
        ...
        <div className="border-b border-white/5">
          ...
          <div className={`overflow-hidden transition-all duration-300 ${mobileServicesOpen ? "max-h-64 pb-3" : "max-h-0"}`}>
            <div className="pl-4 space-y-2">
              ...
              <Link href="/services/interior-detailing" className="block text-base text-gray-400 hover:text-primary transition" onClick={() => setMobileOpen(false)}>Auto Detailing</Link>
              <Link href="/services/paint-protection" className="block text-base text-gray-400 hover:text-primary transition" onClick={() => setMobileOpen(false)}>Paint Correction</Link>
              <Link href="/services/exterior-detailing" className="block text-base text-gray-400 hover:text-primary transition" onClick={() => setMobileOpen(false)}>Ceramic Coating</Link>
              <Link href="/services/exterior-detailing" className="block text-base text-gray-400 hover:text-primary transition" onClick={() => setMobileOpen(false)}>Car Washing &amp; Window Tinting</Link>
            </div>
          </div>
        </div>
