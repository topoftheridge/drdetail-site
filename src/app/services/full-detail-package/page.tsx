...
export const metadata: Metadata = {
  title: "Complete Detail Package | DR Detail",
  description: "Complete detail package — interior + exterior detailing bundled for a full vehicle refresh. Starting at $180. Montgomery County, PA.",
};
  ...
  return (
    <section className="relative py-16 lg:py-24 bg-white">
      ...
      <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-12">
          <h1 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-4">Complete Detail Package</h1>
          <p className="text-primary font-bold text-xl drop-shadow-[0_0_14px_rgba(139,26,26,0.7)]">Starting at $180</p>
          <p className="text-gray-500 mt-2">Most vehicles typically fall between $180–$280 depending on size and condition.</p>
        </div>
        ...
        <h2 className="text-2xl font-bold text-gray-900 mb-6">Exterior — What&apos;s Included</h2>
        ...
        <h2 className="text-2xl font-bold text-gray-900 mb-6">Interior — What&apos;s Included</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-12">
          {[
        ...
        <div className="mt-12 flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          <a href="tel:+16109419000" className="inline-flex items-center justify-center gap-2 bg-white/10 backdrop-blur text-white font-bold px-8 py-4 rounded-lg hover:bg-white/20 transition border border-white/20 text-lg">
            <Phone className="w-5 h-5" /> Call (610) 941-9000
          </a>
        </div>
