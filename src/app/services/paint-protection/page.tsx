...
export const metadata: Metadata = {
  title: "Paint Enhancement & Protection | DR Detail",
  description: "Paint enhancement and protection services in Montgomery County, PA. Full wax, compound buff & wax, engine detail, and floormat replacement.",
};
